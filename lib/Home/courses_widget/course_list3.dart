...
import '../../data/course_data3.dart';
import 'course_widget.dart';

class CourseListScreen3 extends StatelessWidget {
  const CourseListScreen3({super.key});
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: GridView.builder(
                        ...
                        itemCount: DataList3.courses.length,
                        itemBuilder: (context, index) {
                          final course = DataList3.courses[index];
